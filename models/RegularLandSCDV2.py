...
from models.backbone.iswin_transformerv4 import *
...
class RegularLandSCDV2(nn.Module):
    def __init__(self, pretrain_img_size=256, num_classes=6, in_chans = 6, use_attens=1):
        ...
        sr_ratio = [8, 4, 2, 1]
        for i in range(4):
            self.attn_conv_encoder.append(Attention(96 * 2 ** i,
...
if __name__ == '__main__':
    ...
    model = RegularLandSCDV2(pretrain_img_size=256).to(device)
