...
class ISwinUperNetV5(nn.Module):
    def __init__(self, pretrain_img_size=224, num_classes=6, in_chans = 6, use_attens=1):
...
def register_hooks(module):
    if isinstance(module, torch.nn.Conv2d):
        module.total_ops = 0  # Initialize total_ops attribute
...
if __name__ == '__main__':
    ...
    models = ISwinUperNetV5(pretrain_img_size=256).to(device)
    ...
    # input = torch.randn(4, 6, 256, 256).to(device)
