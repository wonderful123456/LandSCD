...
from timm.models.efficientnet import (EfficientNet, decode_arch_def,
                                      default_cfgs, round_channels)
...
# def prepare_settings(cfg):
#     if isinstance(cfg, dict):
#         return {
#             "mean": cfg.get("mean", [0.485, 0.456, 0.406]),
#             "std": cfg.get("std", [0.229, 0.224, 0.225]),
#             "input_space": cfg.get("input_space", "RGB"),
#             "input_range": cfg.get("input_range", [0, 1]),
